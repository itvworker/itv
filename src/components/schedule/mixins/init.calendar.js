export default {
    ...
    methods: {
        ...
        initWeek(year, month, day, dayWeek) {
            let nowWeek = this.calcWeek(year, month, day, dayWeek);
            
            let oneday = 3600 * 24 *1000;
            //上一星期的计算
            let ptampTime = new Date(nowWeek[0].msg).getTime() - oneday;
            ...
            //下个星期的计算   
            let ntampTime = new Date(nowWeek[6].msg).getTime() + oneday;
