                ...
                >
                    ...
                    <div class="week-item">
                        <div
                            ...
                            :class="{'day-today': today === item.key ,'day-active':currentValue===item.time,'gray': !item.hasSchedule,'forbid':item.number > maxMonthNumber || item.number < minMonthNumber  }"
                            v-for="(item, index) in nowWeek"
                            :key="item.id"
                        >
                            <span class="month-name" v-if="item.day===1 || index === 0">{{item.month}}月</span>
                            <div class="active">
                                {{item.day}}
                            </div>
                ...
                >   
                    ...
                    <div class="month-item now-item-month" >
                        ...
                        <div
                            ...
                            :class="{ 'day-today': today === item.key ,'day-active':currentValue===item.time,  'gray': !item.hasSchedule,'prev-month': item.type==='prev', 'next-month': item.type==='next'}"
